...
Public Class PcscProvider
    ...
    Public Const winscardDLLFName As String = "winscard.dll"
...
#Region "ACS IOCTL Class"
    ...
    Public Const IOCTL_SMARTCARD_ENABLE_PIN_VERIFICATION As Long = FILE_DEVICE_SMARTCARD + 2075 * 4
    Public Const IOCTL_SMARTCARD_ENABLE_PIN_MODIFICATION As Long = FILE_DEVICE_SMARTCARD + 2076 * 4
    Public Const IOCTL_SMARTCARD_DISABLE_SECURE_PIN_ENTRY As Long = FILE_DEVICE_SMARTCARD + 2077 * 4
    Public Const IOCTL_SMARTCARD_GET_FIRMWARE_VERSION As Long = FILE_DEVICE_SMARTCARD + 2078 * 4
    Public Const IOCTL_SMARTCARD_DISPLAY_LCD_MESSAGE As Long = FILE_DEVICE_SMARTCARD + 2079 * 4
    Public Const IOCTL_SMARTCARD_READ_KEY As Long = FILE_DEVICE_SMARTCARD + 2080 * 4
    Public Const CM_IOCTL_GET_FEATURE_REQUEST As Long = FILE_DEVICE_SMARTCARD + 3400 * 4
...
#Region "Error Codes"
    ...
    Public Const SCARD_E_NO_READERS_AVAILABLE As Integer = -2146435026
    ...
    Public Const SCARD_E_DIR_NOT_FOUND As Integer = -2146435037

    Public Const SCARD_W_REMOVED_CARD As Integer = -2146434967
#End Region
...
#Region "Prototypes"
    ...
    Public Shared Function SCardEstablishContext(ByVal dwScope As Integer, ByVal pvReserved1 As Integer, ByVal pvReserved2 As Integer, ByRef phContext As IntPtr) As Integer
    End Function
    ...
    ''' <returns></returns>
    <DllImport(winscardDLLFName)>
    Public Shared Function SCardReleaseContext(ByVal phContext As IntPtr) As Integer
    End Function
    ...
    ''' <returns></returns>
    <DllImport(winscardDLLFName)>
    Public Shared Function SCardConnect(ByVal hContext As IntPtr, ByVal szReaderName As String, ByVal dwShareMode As Integer, ByVal dwPrefProtocol As Integer, ByRef phCard As IntPtr, ByRef activeProtocol As Integer) As Integer
    End Function
    ...
    <DllImport(winscardDLLFName)>
    Public Shared Function SCardBeginTransaction(ByVal hCard As IntPtr) As Integer
    End Function
    ...
    ''' <returns>This function returns different values depending on whether it succeeds or fails.</returns>
    <DllImport(winscardDLLFName)>
    Public Shared Function SCardDisconnect(ByVal hCard As IntPtr, ByVal Disposition As Integer) As Integer
    End Function
    ...
    ''' <returns>This function returns different values depending on whether it succeeds or fails.</returns>
    <DllImport(winscardDLLFName)>
    Public Shared Function SCardListReaderGroups(ByVal hContext As IntPtr, ByRef mzGroups As String, ByRef pcchGroups As Integer) As Integer
    End Function
    ...
    Public Shared Function SCardListReaders(ByVal hContext As IntPtr, ByVal Groups As Byte(), ByVal Readers As Byte(), ByRef pcchReaders As Integer) As Integer
    End Function
    ...
    <DllImport(winscardDLLFName)>
    Public Shared Function SCardStatus(ByVal hCard As IntPtr, ByVal szReaderName As String, ByRef pcchReaderLen As Integer, ByRef State As Integer, ByRef Protocol As Integer, ByVal ATR As Byte(),
    ...
    ''' <returns>This function returns different values depending on whether it succeeds or fails.</returns>
    <DllImport(winscardDLLFName)>
    Public Shared Function SCardEndTransaction(ByVal hCard As IntPtr, ByVal Disposition As Integer) As Integer
    End Function
    ...
    Public Shared Function SCardTransmit(ByVal hCard As IntPtr, ByRef pioSendRequest As SCARD_IO_REQUEST, ByVal SendBuff As Byte(), ByVal SendBuffLen As Integer, ByRef pioRecvRequest As SCARD_IO_REQUEST, ByVal RecvBuff As Byte(),
    ...
    ''' <returns>This function returns different values depending on whether it succeeds or fails.</returns>
    <DllImport(winscardDLLFName)>
    Public Shared Function SCardControl(ByVal hCard As IntPtr, ByVal dwControlCode As UInteger, ByVal SendBuff As Byte(), ByVal SendBuffLen As Integer, <[In](), Out()> ByVal RecvBuff As Byte(), ByVal RecvBuffLen As Integer,
     <[In](), Out()> ByRef pcbBytesReturned As Integer) As Integer
    End Function


    <DllImport(winscardDLLFName)>
    Public Shared Function SCardReconnect(ByVal hContext As IntPtr, ByVal dwShareMode As Integer, ByVal dwPrefProtocol As Integer, ByVal dwInitialization As Integer, ByRef activeProtocol As Integer) As Integer
    End Function
...
#Region "Miscellaneous"
    ...
    ''' <returns></returns>
    Public Shared Function GetTagType(ByVal sel_Res As Byte) As String
        Select Case sel_Res
            Case &H0
