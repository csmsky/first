...
Public Class introductory
    ...
    Private Sub introductory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim Query = "SELECT type FROM ride_pricing_tbl"
    ...
    Private Sub ClickMe(ByVal sender As Object, e As EventArgs)
        ...
        mainform.ButtonPromo.Text = btn.Text
        ResetMoneyFields()
        'mainform.txtMainQTY.Text = "0"
        ...
        'Select the price for designated ride
        Using conn As New MySqlConnection(strConn),
